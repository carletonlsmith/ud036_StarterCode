...
the_departed = media.Movie('The Departed', 'A cop and a crook go undercover',
                        'https://upload.wikimedia.org/wikipedia/en/5/50/Departed234.jpg',  # NOQA
                        'https://www.youtube.com/watch?v=rEL0vRfpW6w')

the_town = media.Movie('The Town', 'Bankrobbers terrorize Charlestown',
                        'https://upload.wikimedia.org/wikipedia/en/d/da/The_Town_Poster.jpg',  # NOQA
                        'https://www.youtube.com/watch?v=uAjECYnrYks')

the_sandlot = media.Movie('The Sandlot', 'Rag-tag kids on a quest to recover' +
...
back_to_the_future = media.Movie('Back to the Future',
                        'Marty McFly gets sent back in time',
...
movies = [toy_story, school_of_rock, the_departed, the_town, the_sandlot, back_to_the_future]  # NOQA
